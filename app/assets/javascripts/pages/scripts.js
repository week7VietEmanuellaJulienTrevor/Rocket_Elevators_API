  ...
  jQuery(window).ready(function () {
    jQuery.fn.extend({
      ...
      loadScript(plugin_path + "bootstrap/js/bootstrap.min.js", function () {
        jQuery("body").hasClass("enable-materialdesign") &&
...
function _slider_full() {
  (_headerHeight = 0),
    ...
    jQuery("#slider").hasClass("thirdheight") &&
      jQuery("#slider.thirdheight").height(_screenHeight / 1.5),
    jQuery("#slider").hasClass("fullheight") &&
...
function _topNav() {
  ...
  jQuery(window).scroll(function () {
    jQuery(document).scrollTop() > 100
      ...
      : jQuery("#toTop").is(":visible") && jQuery("#toTop").hide();
  });
  var t = !1;
  if (
    (jQuery("#topMain a.dropdown-toggle").bind("click", function (e) {
      "#" == jQuery(this).attr("href") && e.preventDefault(),
        (t = jQuery(this).parent().hasClass("resp-active")),
    ...
    jQuery("li.quick-cart>a").click(function (e) {
      ...
      t.is(":visible")
        ? t.fadeOut(300)
        : (t.fadeIn(300),
          jQuery("li.search .search-box").is(":visible") &&
            jQuery(".search-box").fadeOut(300));
    }),
    0 != jQuery("li.quick-cart>a").size() &&
      (jQuery("li.quick-cart").on("click", function (e) {
        e.stopPropagation();
      }),
      jQuery("body").on("click", function () {
        jQuery("li.quick-cart div.quick-cart-box").is(":visible") &&
          jQuery("li.quick-cart div.quick-cart-box").fadeOut(300);
      })),
    jQuery("#page-menu ul.menu-scrollTo>li").bind("click", function (e) {
      var t = jQuery("a", this).attr("href");
      jQuery("a", this).hasClass("external") ||
        (e.preventDefault(),
    ...
    jQuery("button.btn-mobile").bind("click", function (e) {
      e.preventDefault(),
        ...
        jQuery(this).hasClass("btn-mobile-active")
    ...
    e.addClass("dropup"),
      ...
      e.hasClass("sticky") &&
        ((window.isOnTop = !0),
        jQuery(window).scroll(function () {
          jQuery(document).scrollTop() > window.homeHeight / 2
    ...
    if (
      ...
      window.width <= 992 && _topBar_H < 1)
    ) {
      jQuery(document).scrollTop();
      (l = e.outerHeight() || 0),
        e.addClass("fixed"),
        jQuery("body").css({ "padding-top": l + "px" });
    }
    if (e.hasClass("transparent"))
      var n = jQuery("#topNav div.nav-main-collapse"),
    ...
    jQuery(window).scroll(function () {
      ...
      e.hasClass("transparent") &&
        (("" == r && "" == i) ||
          (t > 0
            ? window._cmScroll < 1 &&
              (n.removeClass(r, i).addClass(i), (window._cmScroll = 1))
            : t < 1 &&
              (n.removeClass(r, i).addClass(r), (window._cmScroll = 0))));
    });
      ...
      setInterval(function () {
        a &&
          (!(function () {
            ...
            t > o && t > l
              ? e.removeClass("nav-down").addClass("nav-up")
              : t + jQuery(window).height() < jQuery(document).height() &&
                e.removeClass("nav-up").addClass("nav-down");
            o = t;
          })(),
          (a = !1));
      }, 100);
    ...
    jQuery(window).scroll(function () {
      ((window.width > 992 && _topBar_H < 1) || _topBar_H > 0) &&
        (jQuery(document).scrollTop() > _topBar_H
          ? (e.addClass("fixed"), (l = e.outerHeight() || 0))
          : e.removeClass("fixed"));
    });
  ...
  if (
    (jQuery("#slidetop a.slidetop-toggle").bind("click", function () {
      jQuery("#slidetop .container").slideToggle(150, function () {
        jQuery("#slidetop .container").is(":hidden")
    ...
    jQuery(document).keyup(function (e) {
      27 == e.keyCode &&
        jQuery("#slidetop").hasClass("active") &&
        jQuery("#slidetop .container").slideToggle(150, function () {
          jQuery("#slidetop").removeClass("active");
        });
    }),
    jQuery("a#sidepanel_btn").bind("click", function (e) {
      e.preventDefault(),
        (c = "right"),
        jQuery("#sidepanel").hasClass("sidepanel-inverse") && (c = "left"),
        jQuery("#sidepanel").is(":hidden")
    ...
    jQuery(document).keyup(function (e) {
      27 == e.keyCode &&
        jQuery("#sidepanel").is(":visible") &&
        jQuery("a#sidepanel_btn").trigger("click");
    }),
    jQuery("#menu_overlay_open").length > 0)
  ) {
    var u = !!jQuery("html").hasClass("ie9");
    1 == u && jQuery("#topMain").hide(),
      jQuery("#menu_overlay_open").bind("click", function (e) {
        e.preventDefault(),
          jQuery("body").addClass("show-menu"),
          1 == u && jQuery("#topMain").show();
      }),
      jQuery("#menu_overlay_close").bind("click", function (e) {
        e.preventDefault(),
          jQuery("body").hasClass("show-menu") &&
  ...
  if (
    jQuery("#sidebar_vertical_btn").length > 0 &&
    jQuery("body").hasClass("menu-vertical-hide")
  ) {
    if (
      ((_paddingStatusL = jQuery("#mainMenu.sidebar-vertical").css("left")),
      (_paddingStatusR = jQuery("#mainMenu.sidebar-vertical").css("right")),
      parseInt(_paddingStatusL) < 0)
    )
      var c = "left";
    else if (parseInt(_paddingStatusR) < 0) c = "right";
    else c = "left";
    jQuery("#sidebar_vertical_btn").bind("click", function (e) {
      (_paddingStatus = jQuery("#mainMenu.sidebar-vertical").css(c)),
        parseInt(_paddingStatus) < 0
          ? "right" == c
      ...
      jQuery(window).scroll(function () {
        (_paddingStatus = parseInt(
          jQuery("#mainMenu.sidebar-vertical").css(c)
        )),
          _paddingStatus >= 0 &&
            ("right" == c
              ? jQuery("#mainMenu.sidebar-vertical")
...
function _animate() {
  jQuery("body").hasClass("enable-animation") &&
    new WOW({
      boxClass: "wow",
    ...
    loadScript(plugin_path + "owl-carousel/owl.carousel.min.js", function () {
      _container.each(function () {
        ...
        function buildProgressBar() {
          ($progressBar = jQuery("<div>", { id: "progressBar" })),
            ($bar = jQuery("<div>", { id: "bar" })),
    ...
    loadScript(
      ...
      function () {
        if (jQuery().flexslider) {
          ...
          (r = "true" == r),
            (t =
              "thumbnails" == t ? "thumbnails" : "true" == t || "false" != t),
            (_directionNav = "thumbnails" != t && 0 != t),
            jQuery(e).flexslider({
              animation: "slide",
              controlNav: t,
...
function _parallax() {
  ...
  if (e.length > 0 && e.hasClass("parallax-slider")) {
    if (window.width < 768 && e.hasClass("pallax-slider-mobile-deisable"))
      return !1;
    e.offset().top;
    jQuery(window).scroll(function () {
      var t = jQuery(document).scrollTop(),
      ...
      if (t < 768) {
        ...
        jQuery("#slider>div").css("top", 0.5 * t - Number(n)),
          e.hasClass("parallax-slider-noopacity") ||
            jQuery("#slider>div").css("opacity", 1 - (t / r) * 1);
      }
    });
  }
}
      ...
      if (jQuery().mb_YTPlayer) {
        /Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(navigator.userAgent),
          ...
          jQuery("#video-volume").bind("click", function () {
            jQuery("i.fa", this).hasClass("fa-volume-down")
  ...
  jQuery("div.toggle.active > p").addClass("preview-active"),
    ...
    jQuery("div.toggle > label").click(function (e) {
      var t = jQuery(this).parent(),
        ...
        r = !1;
      if (
        (n.hasClass("toggle-accordion") &&
          void 0 !== e.originalEvent &&
          n.find("div.toggle.active > label").trigger("click"),
      ...
      t.hasClass("active")
        ? (jQuery(r).animate({ height: a }, 350, function () {
            jQuery(this).addClass("preview-active");
          }),
          o.slideDown(350))
        : (jQuery(r).animate({ height: 25 }, 350, function () {
...
function _wrotate() {
  jQuery(".word-rotator").each(function () {
    ...
    t.append(r),
      e.height(i).addClass("active"),
      setInterval(function () {
        (o = a * i),
          t.animate({ top: -o + "px" }, 300, "easeOutQuad", function () {
    ...
    loadScript(
      ...
      function () {
        e.each(function () {
          ...
          e.textrotator({ animation: t, speed: parseInt(n) });
        });
      }
    );
}
...
function _misc() {
  if (
    ...
    jQuery("#portfolio.portfolio-isotope").length > 0 &&
      loadScript(plugin_path + "isotope/isotope.pkgd.min.js", function () {
        if (jQuery().isotope) {
          var e = jQuery("#portfolio");
          function t() {
            (_dw = jQuery(document).width()),
              e.hasClass("fullwidth")
                ? ((_w = e.width()),
                  (_wItem = _w / _cols),
                  _dw < 760 && (_wItem = _w / 2),
                  _dw < 480 && (_wItem = jQuery("#portfolio").width()),
          ...
          e.hasClass("portfolio-isotope-2")
            ? (_cols = 2)
            : e.hasClass("portfolio-isotope-3")
            ? (_cols = 3)
            : e.hasClass("portfolio-isotope-4")
            ? (_cols = 4)
            : e.hasClass("portfolio-isotope-5")
            ? (_cols = 5)
            : e.hasClass("portfolio-isotope-6")
            ? (_cols = 6)
            : (_cols = 4),
            t(),
            jQuery(window).on("load", function () {
              setTimeout(function () {
                e.isotope({
                  ...
                  jQuery("#portfolio_filter>li>a").bind("click", function (t) {
                    t.preventDefault(),
                      jQuery("#portfolio_filter>li.active").removeClass(
                        "active"
                      ),
    ...
    jQuery("#blog.blog-isotope").length > 0 &&
      loadScript(plugin_path + "isotope/isotope.pkgd.min.js", function () {
        if (jQuery().isotope) {
          var e = jQuery("#blog");
          function t() {
            (_dw = jQuery(document).width()),
              e.hasClass("fullwidth")
                ? ((_w = jQuery(document).width()),
                  (_wItem = _w / _cols),
                  _dw < 760 && (_wItem = _w / 2),
                  _dw < 480 && (_wItem = jQuery("#blog").width()),
          ...
          e.hasClass("blog-isotope-2")
            ? (_cols = 2)
            : e.hasClass("blog-isotope-3")
            ? (_cols = 3)
            : (e.hasClass("blog-isotope-4"), (_cols = 4)),
            t(),
            jQuery(window).on("load", function () {
              setTimeout(function () {
                e.isotope({
    ...
    jQuery(".box-flip").length > 0 &&
      (jQuery(".box-flip").each(function () {
        (_height1 = jQuery(".box1", this).outerHeight()),
          (_height2 = jQuery(".box2", this).outerHeight()),
          _height1 >= _height2 ? (_height = _height1) : (_height = _height2),
    ...
    (_h = e.height() / 2), e.css({ "margin-top": "-" + _h + "px" });
  }
  jQuery(".incr").bind("click", function (e) {
    ...
    jQuery("input[type=file]").length > 0 &&
...
function _stickyFooter() {
  if (jQuery("#footer").hasClass("sticky")) {
    ...
    function r() {
      (e = n.height()),
        (t = jQuery(window).scrollTop() + jQuery(window).height() - e + "px"),
        jQuery(document.body).height() + e > jQuery(window).height()
          ? n.css({ position: "absolute" }).stop().animate({ top: t }, 0)
                ...
                jQuery("#" + n).fadeIn(250, function () {
                  ...
                  e.setSeconds(e.getSeconds() + i),
                    r.countdown({
                      ...
                      expiryUrl: a,
                      onExpiry: function () {
                        jQuery("#" + n + " span.download-message").removeClass(
                          "hide"
                        ),
                          jQuery("#" + n + " span.download-wait").addClass(
                            "hide"
                          );
                      },
                    });
...
function _masonryGallery() {
  jQuery(".masonry-gallery").length > 0 &&
    jQuery(".masonry-gallery").each(function () {
      var e = jQuery(this),
        t = 4;
      e.hasClass("columns-2")
        ? (t = 2)
        : e.hasClass("columns-3")
        ? (t = 3)
        : e.hasClass("columns-4")
        ? (t = 4)
        : e.hasClass("columns-5")
        ? (t = 5)
        : e.hasClass("columns-6") && (t = 6);
      var n = e.find("a:eq(0)").outerWidth(),
        r = e.attr("data-img-big"),
        i = e.width(),
        a = i / t;
      (a = Math.floor(a)) * t >= i && e.css({ "margin-right": "-1px" }),
        t < 6 && e.children("a").css({ width: a + "px" }),
        parseInt(r) > 0 &&
          ((r = Number(r) - 1),
          e.find("a:eq(" + r + ")").css({ width: 2 * n + "px" }),
          loadScript(plugin_path + "isotope/isotope.pkgd.min.js", function () {
            setTimeout(function () {
              e.isotope({ masonry: { columnWidth: n } }), e.isotope("layout");
            }, 1e3);
          }));
    });
}
                  ...
                  e.validate({
                    submitHandler: function (e) {
                      jQuery(e)
                        ...
                        jQuery(e).ajaxSubmit({
                          target:
                            jQuery(e).find(".validate-result").length > 0
                              ? jQuery(e).find(".validate-result")
                              : "",
                          error: function (e) {
                          ...
                          success: function (i) {
                            "_failed_" == (i = i.trim())
                              ...
                              : "_captcha_" == i
                              ? _toastr("Invalid Captcha!", n, "error", !1)
                              : (jQuery(e)
                                  .find(".input-group-addon")
                                  .find(".fa-refresh")
    ...
    loadScript(plugin_path + "form.masked/jquery.maskedinput.js", function () {
      e.each(function () {
        ...
        (_format = e.attr("data-format") || "(999) 999-999999"),
          ...
          e.mask(_format, { placeholder: _placeholder });
      });
    });
}
function _pickers() {
    ...
    loadScript(plugin_path + "spectrum/spectrum.min.js", function () {
      jQuery().spectrum &&
        r.each(function () {
          ...
          if (((_flat = e.attr("data-flat") || !1), "true" == n || "true" == r))
            var a = [
              [
                "#000",
                "#444",
          ...
          e.attr("data-defaultColor")
            ? (_color = e.attr("data-defaultColor"))
            : (_color = "#ff0000"),
        ...
        jQuery().summernote &&
          e.each(function () {
            ...
            "en-US" != e &&
              (alert(e),
              loadScript(
                plugin_path + "editor.summernote/lang/summernote-" + e + ".js"
              )),
          ...
          e.each(function () {
            ...
            (_numLinks = e.attr("data-pajinante-num-links") || 5),
              e.pajinate({
                ...
                item_container_id:
                  e.attr("data-pajinate-container") || ".pajinate-container",
    ...
    loadScript(
      ...
      function () {
        (_navSelector = e.attr("data-nextSelector") || "#inf-load-nex"),
          (_itemSelector = e.attr("data-itemSelector") || ".item"),
      ...
      jQuery().zoom &&
        e.each(function () {
          ...
          "grab" == t
            ...
            ? e.zoom({ on: "toggle" })
            : e.zoom(),
            isMobile.any() && e.zoom({ on: "toggle" }),
            n &&
              jQuery(".zoom-more[data-for=" + n + "] a").bind(
                "click",
                function (e) {
                  e.preventDefault();
                  var t = jQuery(this).attr("href");
                  "#" != t &&
                    (jQuery(".zoom-more[data-for=" + n + "] a").removeClass(
                      "active"
                    ),
                    jQuery(this).addClass("active"),
                    jQuery("figure#" + n + ">.lightbox").attr("href", t),
                    jQuery("figure#" + n + ">img")
                      .fadeOut(0, function () {
      ...
      jQuery().stepper &&
        jQuery(e).each(function () {
          ...
          e.stepper({
            ...
            wheel_step: e.attr("data-wheelstep") || 0.1,
            arrow_step: e.attr("data-arrowstep") || 0.2,
            allowWheel: "false" != e.attr("data-mousescrool"),
            UI: "false" != e.attr("data-UI"),
            type: e.attr("data-type") || "float",
            preventWheelAcceleration:
              "false" != e.attr("data-preventWheelAcceleration"),
            incrementButton:
              e.attr("data-incrementButton") || "&blacktriangle;",
            decrementButton:
              e.attr("data-decrementButton") || "&blacktriangledown;",
            onStep: null,
            onWheel: null,
            onArrow: null,
            onButton: null,
      ...
      function () {
        jQuery().slimScroll &&
          jQuery(".slimscroll").each(function () {
            var e;
            (e = jQuery(this).attr("data-height")
              ...
              jQuery(this).slimScroll({
                ...
                alwaysVisible:
                  "false" != jQuery(this).attr("data-alwaysVisible"),
              ...
              "true" == jQuery(this).attr("disable-body-scroll") &&
                jQuery(this).bind("mousewheel DOMMouseScroll", function (e) {
                  var t = null;
                  "mousewheel" == e.type
                    ? (t = -1 * e.originalEvent.wheelDelta)
                    : "DOMMouseScroll" == e.type &&
                      (t = 40 * e.originalEvent.detail),
                    t &&
                      (e.preventDefault(),
...
function _modalAutoLoad() {
  jQuery("div.modal").length > 0 &&
    jQuery("div.modal").each(function () {
      var e = jQuery(this),
        t = e.attr("id"),
        n = e.attr("data-autoload") || !1;
      "" != t && "hidden" == localStorage.getItem(t) && (n = "false"),
        "true" == n &&
          jQuery(window).on("load", function () {
        ...
        jQuery("input.loadModalHide", this).bind("click", function () {
          jQuery(this).is(":checked")
            ? (localStorage.setItem(t, "hidden"),
              console.log("[Modal Autoload #" + t + "] Added to localStorage"))
            : (localStorage.removeItem(t),
              console.log(
                "[Modal Autoload #" + t + "] Removed from localStorage"
              ));
        });
    });
}
      ...
      jQuery(e).each(function () {
        ...
        if ("" != t) {
          var n = e.attr("data-background-delay") || 3e3,
            ...
            i = t.split(",");
          (i = t.replace(" ", "").split(","))[1]
            ? e.backstretch(i, { duration: parseInt(n), fade: parseInt(r) })
            : e.backstretch(i),
            jQuery(".bs-next", e).bind("click", function (t) {
            ...
            jQuery(window).resize(function () {
              window.afterResizeBkstr && clearTimeout(window.afterResizeBkstr),
...
function _cookie_alert() {
  ...
  if (e.length > 0 && null == t) {
    ...
    e.hasClass("alert-position-bottom")
      ? e.animate({ bottom: "0px" }, 800, "easeInOutExpo")
      : e.animate({ top: "0px" }, 800, "easeInOutExpo"),
      jQuery("button", e).bind("click", function () {
          ...
          e.jflickrfeed(
            {
              ...
              qstrings: { id: t },
              itemTemplate:
                '<li><a href="{{image}}" title="{{title}}"><img src="{{image_s}}" alt="{{title}}" width="63" height="63" /></a></li>',
            },
            function (e) {
              _lightbox();
            }
...
function relative_time(e) {
  ...
  return (
    (e = t[1] + " " + t[2] + ", " + t[5] + " " + t[3]),
    (i += 60 * r.getTimezoneOffset()) < 60
      ? "less than a minute ago"
      : i < 120
      ? "about a minute ago"
      : i < 3600
      ? parseInt(i / 60).toString() + " minutes ago"
      : i < 7200
      ? "about an hour ago"
      : i < 86400
      ? "about " + parseInt(i / 3600).toString() + " hours ago"
      : i < 172800
      ? "1 day ago"
      : parseInt(i / 86400).toString() + " days ago"
  );
}
function _widget_facebook() {
  ...
  (i.length > 0 || a.length > 0) &&
    ...
    e.getElementById(t) ||
      ...
      (n.src = "//connect.facebook.net/en_US/sdk.js#xfbml=1&version=v2.3"),
        ...
        jQuery.jribbble
          ...
          .then(function (t) {
            ...
            t.forEach(function (e) {
              r.push("<li>"),
                r.push('<a href="' + e.html_url + '" target="' + n + '">'),
                r.push(
...
/pofweb/.test(self.location.href) ||
  /wcdn/.test(self.location.href) ||
  /tstrap/.test(self.location.href);
var isMobile = {
  iOS: function () {
  ...
  (e = this),
    (t = function () {
      ...
      function o(e, t) {
        ...
        if ((e !== d && t !== d) || r.contains(s))
          return (
            (u = d),
            (c = u.nodeName),
            "BODY" === c || ("HTML" !== c && i(u.firstElementChild) !== u)
              ? i(d)
              : d
          );
        var p = a(e);
      ...
      function f(e, n) {
        ...
        return (
          (i ? n.contains(u) : n === u && "BODY" !== u.nodeName) &&
            (m = (function (e, t) {
              var n =
                  2 < arguments.length &&
                  void 0 !== arguments[2] &&
      ...
      function h(e, i, a, l) {
        ...
        if ("viewport" === l)
          (u = w),
            (p = u.ownerDocument.documentElement),
            (h = f(u, p)),
            (m = M(p.clientWidth, window.innerWidth || 0)),
            (y = M(p.clientHeight, window.innerHeight || 0)),
            (g = s(p)),
            (v = s(p, "left")),
            (j = d({
          ...
          var Q;
          "scrollParent" === l
            ? "BODY" === (Q = r(n(i))).nodeName &&
              (Q = e.ownerDocument.documentElement)
            : (Q = "window" === l ? e.ownerDocument.documentElement : l);
          var b = f(Q, w);
          if (
            "HTML" !== Q.nodeName ||
            (function e(r) {
            ...
            var _ = c(),
              C = _.height,
              A = _.width;
            (j.top += b.top - b.marginTop),
              (j.bottom = C + b.top),
              (j.left += b.left - b.marginLeft),
              (j.right = A + b.left);
          }
        }
        ...
        var l = /\s*,\s*|\s+/,
          u =
            -1 === s
              ? [o]
              : [
                  o.slice(0, s).concat([o[s].split(l)[0]]),
                  [o[s].split(l)[1]].concat(o.slice(s + 1)),
                ];
        return (
      ...
      var z,
        ...
        L = function () {
          return (
            void 0 == z && (z = -1 !== navigator.appVersion.indexOf("MSIE 10")),
            z
          );
        },
        q = function (e, t) {
        ...
        Z = (function () {
          function t(n, r) {
            ...
            q(this, t),
              ...
              Object.keys(W({}, t.Defaults.modifiers, a.modifiers)).forEach(
                function (e) {
                  i.options.modifiers[e] = W(
                    {},
        ...
        (Z.Defaults = {
          ...
          modifiers: {
            ...
            arrow: {
              ...
              fn: function (e, n) {
                ...
                var a = e.placement.split("-")[0],
                  ...
                  m = u ? "bottom" : "right",
                  y = g(i)[c];
                l[m] - y < s[f] && (e.offsets.popper[f] -= s[f] - (l[m] - y)),
                  l[f] + y > s[m] && (e.offsets.popper[f] += l[f] + y - s[m]),
                ...
                return (
                  o.forEach(function (s, l) {
                    ...
                    var u,
                      ...
                      p = B,
                      f =
                        ("left" === r && p(c.right) > p(d.left)) ||
                        ("right" === r && p(c.left) < p(d.right)) ||
                        ("top" === r && p(c.bottom) > p(d.top)) ||
                        ("bottom" === r && p(c.top) < p(d.bottom)),
                      h = p(c.left) < p(n.left),
            ...
            hide: {
              ...
              enabled: !0,
              fn: function (e) {
                if (!E(e.instance.modifiers, "hide", "preventOverflow"))
                  return e;
            ...
            computeStyle: {
              ...
              fn: function (e, t) {
                ...
                var s,
                  ...
                  y = _("transform");
                if (
                  ((l = "bottom" == h ? -c.height + f.bottom : f.top),
                  (s = "right" == m ? -c.width + f.right : f.left),
                  u && y)
                )
                  (d[y] = "translate3d(" + s + "px, " + l + "px, 0)"),
                    (d[h] = 0),
                    (d[m] = 0),
                ...
                return (
                  (e.attributes = W({}, j, e.attributes)),
                  (e.styles = W({}, d, e.styles)),
              ...
              fn: function (e) {
                return (
                  ...
                  e.arrowElement &&
                    ...
                    S(e.arrowElement, e.arrowStyles),
                  e
                );
                var t, n;
              },
...
(Number.prototype.formatMoney = function (e, t, n) {
  ...
  return (
    i +
    (o ? a.substr(0, o) + n : "") +
    a.substr(o).replace(/(\d{3})(?=\d)/g, "$1" + n) +
    (e
      ? t +
        Math.abs(r - a)
          .toFixed(e)
        ...
        jQuery(this).each(function () {
          ...
          o.data("countTo", u),
            ...
            (u.interval = setInterval(function () {
              s++,
                c((l += i)),
                "function" == typeof n.onUpdate && n.onUpdate.call(a, l);
              s >= r &&
                (o.removeData("countTo"),
                clearInterval(u.interval),
                (l = n.to),
                "function" == typeof n.onComplete && n.onComplete.call(a, l));
            }, n.refreshInterval)),
            c(l);
        })
      );
    ...
    (e.fn.appear = function (t, n) {
      ...
      return this.each(function () {
        ...
        if (((n.appeared = !1), t)) {
          var i = e(window),
            a = function () {
              if (n.is(":visible")) {
                ...
                o + p + l >= e &&
                o <= e + f + l
                  ? n.appeared || n.trigger("appear", r.data)
                  : (n.appeared = !1);
              } else n.appeared = !1;
            },
            o = function () {
          ...
          r.one ? n.one("appear", r.data, o) : n.bind("appear", r.data, o),
            i.scroll(a),
            e.fn.appear.checks.push(a),
            a();
  ...
  (jQuery.fn.parallax = function (e, t, n) {
    function r() {
  ...
  jQuery.extend(jQuery.easing, {
    ...
    easeOutElastic: function (e, t, n, r, i) {
      ...
      return (
        s * Math.pow(2, -10 * t) * Math.sin(((t * i - a) * (2 * Math.PI)) / o) +
        r +
        n
      );
    },
    ...
    easeInOutBack: function (e, t, n, r, i, a) {
      return (
        void 0 == a && (a = 1.70158),
        (t /= i / 2) < 1
          ? (r / 2) * (t * t * ((1 + (a *= 1.525)) * t - a)) + n
          : (r / 2) * ((t -= 2) * t * ((1 + (a *= 1.525)) * t + a) + 2) + n
      );
    },
      ...
      (this.WOW = (function () {
        ...
        return (
            ...
            if (
              ...
              (this.boxes = function () {
                ...
                for (
                  i = [],
                    e = 0,
                    n = (r = this.element.querySelectorAll(
          ...
          (i.prototype.vendorCSS = function (e, t) {
            var n, i, a, o, s, l;
            for (
              n = (i = r(e)).getPropertyCSSValue(t),
                o = 0,
                s = (l = this.vendors).length;
              s > o;
              o++
            )
  ...
  (function (e, t, n) {
    ...
    function i(e) {
      ...
      g._config.enableClasses &&
        ((t += " " + n + e.join(" " + n)),
        w ? (j.className.baseVal = t) : (j.className = t));
    }
    function a() {
    ...
    function o(e, t) {
      if ("object" == typeof e) for (var n in e) _(e, n) && o(n, e[n]);
      else {
    ...
    function d(t, i, o, u) {
      ...
      for (
        var f, h, m, y, g, v = ["modernizr", "tspan", "samp"];
        !O.style && v.length;
        ...
        : (function (e, t, n) {
            ...
            for (var a in e)
              if (e[a] in t)
                return !1 === n
                  ? e[a]
                  : ((i = t[e[a]]), r(i, "function") ? u(i, n || t) : i);
            return !1;
          ...
          return (
            !h.shivCSS ||
              ...
              (f.hasCSS =
                ...
                (d = (u = e).createElement("p")),
                (p = u.getElementsByTagName("head")[0] || u.documentElement),
                (d.innerHTML = "x<style>" + c + "</style>"),
                !!p.insertBefore(d.lastChild, p.firstChild))),
            s ||
              ((a = e),
              (l = f).cache ||
                ((l.cache = {}),
                (l.createElem = a.createElement),
                (l.createFrag = a.createDocumentFragment),
                (l.frag = l.createFrag())),
    ...
    (y.hasEvent = A),
      ...
      (_ =
        r((C = {}.hasOwnProperty), "undefined") || r(C.call, "undefined")
          ? function (e, t) {
    ...
    g._q.unshift(function () {
      ...
      (y.prefixed = function (e, t, n) {
        return 0 === e.indexOf("@")
          ? E(e)
          : (-1 != e.indexOf("-") && (e = s(e)), t ? p(e, t, n) : p(e, "pfx"));
      }),
      (y.testAllProps = f),
      g.addTest("csstransitions", f("transition", "all", !0)),
      g.addTest("csstransforms3d", function () {
      ...
      (function () {
        ...
        for (var l in m)
          if (m.hasOwnProperty(l)) {
            ...
            for (
              i = r(t.fn, "function") ? t.fn() : t.fn, a = 0;
              a < e.length;
              a++
            )
              (o = e[a]),
                ...
                1 === s.length
                  ? (g[s[0]] = i)
                  : (!g[s[0]] ||
                      g[s[0]] instanceof Boolean ||
                      (g[s[0]] = new Boolean(g[s[0]])),
                    (g[s[0]][s[1]] = i)),
                h.push((i ? "" : "no-") + s.join("-"));
          }
      })(),
