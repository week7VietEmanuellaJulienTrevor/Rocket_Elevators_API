...
class BuildingDetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create building_detail" do
    assert_difference('BuildingDetail.count') do
      post building_details_url, params: { building_detail: { information_key: @building_detail.information_key, value: @building_detail.value } }
    end
  ...
  test "should update building_detail" do
    patch building_detail_url(@building_detail), params: { building_detail: { information_key: @building_detail.information_key, value: @building_detail.value } }
