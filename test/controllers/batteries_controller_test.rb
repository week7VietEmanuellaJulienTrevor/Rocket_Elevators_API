...
class BatteriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create battery" do
    assert_difference('Battery.count') do
      post batteries_url, params: { battery: { building_id: @battery.building_id, commissioning_date: @battery.commissioning_date, employee_id: @battery.employee_id, information: @battery.information, last_inspection_date: @battery.last_inspection_date, notes: @battery.notes, operations_certificate: @battery.operations_certificate, status: @battery.status, type: @battery.type } }
    end
  ...
  test "should update battery" do
    patch battery_url(@battery), params: { battery: { building_id: @battery.building_id, commissioning_date: @battery.commissioning_date, employee_id: @battery.employee_id, information: @battery.information, last_inspection_date: @battery.last_inspection_date, notes: @battery.notes, operations_certificate: @battery.operations_certificate, status: @battery.status, type: @battery.type } }
