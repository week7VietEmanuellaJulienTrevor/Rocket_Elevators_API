...
class ElevatorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create elevator" do
    assert_difference('Elevator.count') do
      post elevators_url, params: { elevator: { column_id: @elevator.column_id, commissioning_date: @elevator.commissioning_date, information: @elevator.information, inspection_certificate: @elevator.inspection_certificate, last_inspection_date: @elevator.last_inspection_date, model: @elevator.model, notes: @elevator.notes, serial_number: @elevator.serial_number, status: @elevator.status, type: @elevator.type } }
    end
  ...
  test "should update elevator" do
    patch elevator_url(@elevator), params: { elevator: { column_id: @elevator.column_id, commissioning_date: @elevator.commissioning_date, information: @elevator.information, inspection_certificate: @elevator.inspection_certificate, last_inspection_date: @elevator.last_inspection_date, model: @elevator.model, notes: @elevator.notes, serial_number: @elevator.serial_number, status: @elevator.status, type: @elevator.type } }
