...
class CustomersTest < ApplicationSystemTestCase
  ...
  test "creating a Customer" do
    ...
    fill_in "Email company contact", with: @customer.email_company_contact
    fill_in "Full name company contact", with: @customer.full_name_company_contact
    fill_in "Full name service technical authority", with: @customer.full_name_service_technical_authority
    fill_in "Technical authority phone", with: @customer.technical_authority_phone
    fill_in "Technical manager email", with: @customer.technical_manager_email
